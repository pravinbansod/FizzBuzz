...
public abstract class AbstractFizzBuzzNumberDescriptorService implements NumberDescriptorService {
   ...
   * <ul>
   * <li>Returns FizzBuzz if input number satisfies both FizzDecider and BuzzDecider conditions.</li>
   ...
   * <li>Returns number as it is when input number does not satisfy FizzDecider and BuzzDecider conditions.</li>
   * </ul>
   *
   * @param number
   *          input number
   * @param fizzDecider
   *          Fizz Decider implementation
   * @param buzzDecider
   *          Buzz Decider implementation
   * @return
   */
